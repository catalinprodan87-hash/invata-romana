            ...
            <section>
              ...
              <div className="flex flex-col gap-2">
                {lesson.dialogue.map((line, i) => (
                  <div key={i} className="flex items-start gap-3 rounded-md bg-surface p-3 ring-1 ring-black/5">
              ...
              <section>
                ...
                <ul className="flex flex-col gap-2">
                  {lesson.grammarNotes_uk.map((note, i) => (
                    <li key={i} className="rounded-md bg-surface p-3 text-sm text-text ring-1 ring-black/5">
                      {note}
                    </li>
                  ))}
                </ul>
