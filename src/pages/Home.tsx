  ...
  return (
    <div className="min-h-dvh bg-bg">
      ...
      <main className="mx-auto flex max-w-screen-sm flex-col gap-4 px-4 pb-12 pt-4">
        {/* Daily goal + streak */}
        <div className="flex items-center gap-4 rounded-lg bg-surface p-4 ring-1 ring-black/5">
          <ProgressRing
            value={ringValue}
        ...
        {/* Frequency backbone */}
        <div className="rounded-lg bg-surface p-4 ring-1 ring-black/5">
        ...
        {hasWork ? (
          ...
          <div className="rounded-lg bg-surface p-6 text-center ring-1 ring-black/5">
